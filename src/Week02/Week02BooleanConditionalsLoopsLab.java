...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		//				iv. If there are 5 or more cookies, print "Jackpot!"
			int numberOfCookies=10,numberOfChildren=4,remaningCookies=numberOfCookies % numberOfChildren;
			if (remaningCookies >5) {
				System.out.println("Jackpot");
			}else if (remaningCookies >=2) {
				System.out.println("Whoohoooo");
			}else if (remaningCookies >0) {
		...
		//				iii. "PLATINUM" is 0.25
			...
			default:
				System.out.println ("Unexpected value: " + loyaltyMemberStatus);
			}
		...
		//				loyaltyMemberStatus from SILVER to GOLD or from GOLD to PLATINUM
			double billTotal=580,adjustedTotal=billTotal-(billTotal*loyaltyMemberDiscount);
			System.out.println(adjustedTotal);
			if (adjustedTotal>500) {
				if (loyaltyMemberStatus=="SILVER") {
					loyaltyMemberStatus="GOLD";
				}else if (loyaltyMemberStatus=="GOLD") {
					loyaltyMemberStatus="PLATINIUM";
				}
			}
		...
		//				ii. "access denied" otherwise
		 ...
		 String username="Tommy123",password="12345";
		...
		System.out.println("-----------");
		 ...
		 double moneyInWallet = 4.50;
		  ...
		  double costOfMilka = 1.99;

		  if (moneyInWallet >= costOfMilka * 2) {

		    System.out.println("Let's buy two gallons.");

		  } else if (moneyInWallet >= costOfMilka) {
